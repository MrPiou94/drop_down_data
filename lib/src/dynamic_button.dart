...
class DynamicButton extends StatelessWidget {
 ...
 // final bool colorTextAuto;
  final bool? selected;  // null not visible, false disable color, true enable color
  final bool enabled;
  final String style;         /// Stadium // Rectangle // Circle // Beveled
  final String? title;
  final String? styleTitle;   /// uuid Style
  ...
  const DynamicButton({Key? key,
   // this.colorTextAuto = false,
    this.selected = false,
    this.enabled = true,
    this.style = "Stadium",  /// Stadium // Rectangle // Circle // Beveled
    this.title = "",
    this.styleTitle = "",
    this.tooltip,   // null
    this.icon,      // = null,
      ...
      ButtonStyle(
        ...
        backgroundColor: MaterialStateProperty.resolveWith<Color?>( (Set<MaterialState> states) {
          if (states.contains(MaterialState.pressed)) {
            ...
            return pressColor != null && selected == true ? pressColor : backColor != null ? backColor! //.withOpacity(0.9)
                : selected == true ? colorScheme.primary : colorScheme.primaryContainer;
          }
        },),
        // Elevation
        shadowColor: MaterialStateProperty.resolveWith<Color?>( (Set<MaterialState> states) {
          ...
          if (states.contains(MaterialState.hovered)){return null;}else{
            return shadowColor ?? colorScheme.shadow; // Colors.transparent;
          }
        },),
        // Border
        side: MaterialStateProperty.resolveWith<BorderSide?>( (Set<MaterialState> states) {
          if (states.contains(MaterialState.hovered)){return null;}else{
            return BorderSide(width: 1.5, color: outlineColor ?? colorScheme.outline );
          }
        },),
        // Color Icon
